			...
			<React.Fragment>
				...
				<Consumer>
					{({ state, actions }) => {
						...
						const yesDisabled =
							typeof event.meta_keys._rsvpYes !== "undefined" &&
							event.meta_keys._rsvpYes.includes(
								user.user_nicename
							)
								? "disabled"
								: "";
						const noDisabled =
							typeof event.meta_keys._rsvpNo !== "undefined" &&
							event.meta_keys._rsvpNo.includes(user.user_nicename)
								? "disabled"
								: "";
