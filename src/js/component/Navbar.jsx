			...
			<div>
				<nav className="navbar navbar-light bg-light justify-content-between navbar-expand-sm">
					<Link className="navbar-brand" to="/">
						<img
							className="img-fluid"
							src="https://www.4geeksacademy.co/wp-content/themes/the-fastest/assets/img/logo-black.png"
						/>
					</Link>
					<button
					...
					<div
						...
						<div className="navbar-nav">
							{session &&
							typeof session.user_nicename !== "undefined" ? (
								<div className="d-flex">
									<Link
										className="nav-item nav-link "
										to={
											"/user/" +
											session.user_nicename.value
										}>
										Hello,{" "}
										{session.user_display_name
											.charAt(0)
											.toUpperCase() +
											session.user_display_name.substring(
												1
											)}
									</Link>
									<a
